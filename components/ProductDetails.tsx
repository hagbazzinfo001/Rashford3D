        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-4xl font-bold text-rashford-red">
                ${product.price}
              </span>
                    ...
                    <div className="flex space-x-2">
                      {product.variants.materials.map((material: string) => (
                        <button
                          key={material}
                          onClick={() =>
                            handleVariantChange("material", material)
                          }
                          className={`px-4 py-2 border rounded-lg text-sm font-medium transition-all ${
                        ...
                        <div className="space-y-4">
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-600">
                                On orders over $100. Delivery in 3-7 business
                                days.
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-600">
                                $15.99. Delivery in 1-2 business days.
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-600">
                                Available to 24+ countries. Rates calculated at
                                checkout.
                              </p>
                            </div>
                          </div>
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-all duration-300 flex items-center justify-center">
                      <motion.button
                        ...
                        onClick={() =>
                          onNavigate("product-details", relatedProduct)
                        }
