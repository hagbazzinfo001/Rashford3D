...
export default function AdminAnalytics() {
  ...
  const recentActivity = [
    { type: 'order', message: 'New order #ORD-001 received', time: '2 minutes ago' },
    { type: 'product', message: 'Product "Smart Bulb" stock updated', time: '15 minutes ago' },
    ...
    { type: 'product', message: 'New product "Coffee Maker" added', time: '3 hours ago' },
  ];
  ...
  const kpiCards = [
    ...
    },
    {
      ...
      value: `₦${Math.round(stats.totalRevenue / stats.total).toLocaleString()}`,
      change: '+8.2%',
      changeType: 'increase',
      icon: ShoppingCart,
      color: 'text-blue-600',
