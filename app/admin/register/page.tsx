...
export default function AdminRegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Registration request submitted! You will be contacted within 24 hours.');
      ...
      <div className="w-full max-w-2xl">
        ...
        >
          ...
          <div className="bg-gradient-to-r from-rashford-red to-rashford-gold p-8 text-white text-center">
            ...
            <p className="text-white/90">Request access to Rashford3D Management System</p>
          </div>
          ...
          <div className="p-8">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    Admin accounts require approval. You'll be contacted within 24 hours after submitting your request.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div>
                <label className="flex items-start space-x-3">
                  ...
                  <span className="text-sm text-gray-700">
                    I agree to the{' '}
                    <Link href="/terms" className="text-rashford-red hover:underline">
                      Terms of Service
                    </Link>{' '}
                    and{' '}
                    <Link href="/privacy" className="text-rashford-red hover:underline">
                      Privacy Policy
                    </Link>
            ...
            <div className="mt-6 flex items-center space-x-2 text-sm text-gray-500">
              ...
              <span>All admin requests are reviewed for security compliance</span>
            </div>
          </div>
        </motion.div>
      </div>
