...
const mockProducts: Product[] = [
  {
    ...
    description: 'Revolutionary smart home hub with 3D printed components for maximum durability and style.',
  ...
  },
  {
    ...
    description: 'Premium wireless charging pad with unique 3D textured surface for enhanced aesthetics.',
  ...
  },
  {
    ...
    description: 'High-precision digital kitchen scale with 3D printed ergonomic design.',
  ...
  },
  {
    ...
    description: 'Set of 4 smart LED bulbs with 16 million colors and voice control.',
    ...
    stockQuantity: 156,
    sku: 'RSH-LED-004',
    tags: ['smart-lighting', 'color-changing', 'voice-control', 'energy-efficient'],
    features: [
      '16 million colors',
      'Voice control',
      'Energy efficient',
  ...
  },
  {
    ...
    description: 'Premium coffee maker with 3D printed components and smart brewing technology.',
...
const mockCategories: Category[] = [
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        image: 'https://images.pexels.com/photos/163016/cellular-phone-charge-charging-163016.jpeg?auto=compress&cs=tinysrgb&w=800',
        parentId: 'electronics',
        productCount: 1,
      },
      {
...
export function ProductProvider({ children }: { children: ReactNode }) {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      const response = await axios.get('http://rashroff3decommerce.somee.com/swagger', {
        timeout: 5000,
      });
